...
-- Adicionar constraint para evitar duplicatas futuras
ALTER TABLE organizacoes 
ADD CONSTRAINT unique_organizacao 
UNIQUE ("Organização Militar", "Órgão Setorial Responsável", "Sigla da OM");
...
ALTER TABLE solicitacoes ADD COLUMN contato_nome TEXT;
ALTER TABLE solicitacoes ADD COLUMN contato_telefone TEXT;
ALTER TABLE solicitacoes ADD COLUMN contato_email TEXT;
